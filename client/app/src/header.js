...
const Header = () => {
  ...
  <FaCodepen style={{ fontSize: '65px' }} /> Kerela WasteTech
</a>
...
<div class="dropdown">
  ...
  <li><a class="dropdown-item mt-1 " href={`/Dashboard/${auth?.user?.role ===1 ? "admin" : ""    }`} >DashBoard</a></li>
    <li><a class="dropdown-item mt-2 " >Cart({cart.length})</a></li>
    <li><a class="dropdown-item mt-2" onClick={handellogout} href="/login">Logout</a></li>
  
  </ul>
</div>

                <li  className="tokenquantity mt-2 ">
                  {auth?.user?.tokenn  }<PiCoinVerticalDuotone class="token"/>
                </li>
</>
